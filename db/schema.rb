...
ActiveRecord::Schema[7.1].define(version: 2026_03_06_015040) do
  ...
  create_table("column_preferences", id: :serial, force: :cascade) do |t|
    ...
    t.index(
      ["user_id", "action_name", "column_name"],
      name: "index_column_prefs_on_user_id_and_action_name_and_column_name",
      unique: true
    )
  end
  ...
  create_table("exchanges", id: :serial, force: :cascade) do |t|
    ...
    t.index(
      ["sender_id", "order_cycle_id", "receiver_id", "incoming"],
      name: "index_exchanges_on_sender_id",
      unique: true
    )
  end
  ...
  create_table("inventory_items", id: :serial, force: :cascade) do |t|
    ...
    t.datetime("updated_at", precision: nil, null: false)
    t.index(
      ["enterprise_id", "variant_id"],
      name: "index_inventory_items_on_enterprise_id_and_variant_id",
      unique: true
    )
  end
  ...
  create_table("order_cycles_distributor_payment_methods", id: false, force: :cascade) do |t|
    ...
    t.index(
      ["order_cycle_id", "distributor_payment_method_id"],
  ...
  create_table("proxy_orders", id: :serial, force: :cascade) do |t|
    ...
    t.index(
      ["order_cycle_id", "subscription_id"],
      name: "index_proxy_orders_on_order_cycle_id_and_subscription_id",
      unique: true
    )
  ...
  create_table("vouchers", force: :cascade) do |t|
    ...
    t.index(
      ["code", "enterprise_id", "external_voucher_id"],
      name: "index_vouchers_on_code_and_enterprise_id_and_ext_voucher_id"
    )
  ...
  add_foreign_key(
    ...
    name: "adjustment_metadata_adjustment_id_fk",
    on_delete: :cascade
  )
  ...
  add_foreign_key(
    ...
    name: "distributors_payment_methods_distributor_id_fk"
  )
  add_foreign_key(
    "distributors_payment_methods",
    "spree_payment_methods",
    column: "payment_method_id",
    name: "distributors_payment_methods_payment_method_id_fk"
  )
  add_foreign_key(
    "distributors_shipping_methods",
    "enterprises",
    column: "distributor_id",
    name: "distributors_shipping_methods_distributor_id_fk"
  )
  add_foreign_key(
    "distributors_shipping_methods",
    "spree_shipping_methods",
    column: "shipping_method_id",
    name: "distributors_shipping_methods_shipping_method_id_fk"
  )
  ...
  add_foreign_key(
    ...
    name: "enterprise_fees_tax_category_id_fk"
  )
  ...
  add_foreign_key(
    "enterprise_groups_enterprises",
    "enterprise_groups",
    name: "enterprise_groups_enterprises_enterprise_group_id_fk"
  )
  add_foreign_key(
    "enterprise_groups_enterprises",
    "enterprises",
    name: "enterprise_groups_enterprises_enterprise_id_fk"
  )
  add_foreign_key(
    "enterprise_relationship_permissions",
    "enterprise_relationships",
    name: "erp_enterprise_relationship_id_fk"
  )
  add_foreign_key(
    "enterprise_relationships",
    "enterprises",
    column: "child_id",
    name: "enterprise_relationships_child_id_fk"
  )
  add_foreign_key(
    "enterprise_relationships",
    "enterprises",
    column: "parent_id",
    name: "enterprise_relationships_parent_id_fk"
  )
  ...
  add_foreign_key(
    ...
    "enterprises",
    column: "producer_id",
    name: "producer_properties_producer_id_fk"
  )
  add_foreign_key(
    "producer_properties",
    "spree_properties",
    column: "property_id",
    name: "producer_properties_property_id_fk"
  )
  ...
  add_foreign_key(
    ...
    "spree_orders",
    column: "order_id",
    name: "spree_inventory_units_order_id_fk",
    on_delete: :cascade
  )
  add_foreign_key(
    "spree_inventory_units",
    ...
    name: "spree_inventory_units_return_authorization_id_fk"
  )
  add_foreign_key(
    "spree_inventory_units",
    "spree_shipments",
    column: "shipment_id",
    name: "spree_inventory_units_shipment_id_fk",
    on_delete: :cascade
  )
  add_foreign_key(
    "spree_inventory_units",
    "spree_variants",
    column: "variant_id",
    name: "spree_inventory_units_variant_id_fk"
  )
  ...
  add_foreign_key(
    ...
    "spree_payment_methods",
    column: "payment_method_id",
    name: "spree_payments_payment_method_id_fk"
  )
  ...
  add_foreign_key(
    ...
    "spree_products",
    column: "product_id",
    name: "spree_product_properties_product_id_fk"
  )
  add_foreign_key(
    "spree_product_properties",
    "spree_properties",
    column: "property_id",
    name: "spree_product_properties_property_id_fk"
  )
  ...
  add_foreign_key(
    ...
    name: "spree_products_shipping_category_id_fk"
  )
  add_foreign_key(
    "spree_products",
    "spree_tax_categories",
    column: "tax_category_id",
    name: "spree_products_tax_category_id_fk"
  )
  add_foreign_key(
    "spree_products",
    "spree_taxons",
    column: "primary_taxon_id",
    name: "spree_products_primary_taxon_id_fk"
  )
  add_foreign_key(
    "spree_return_authorizations",
    "spree_orders",
    column: "order_id",
    name: "spree_return_authorizations_order_id_fk"
  )
  ...
  add_foreign_key(
    ...
    "spree_orders",
    column: "order_id",
    name: "spree_shipments_order_id_fk",
    on_delete: :cascade
  )
  ...
  add_foreign_key(
    ...
    "spree_tax_categories",
    column: "tax_category_id",
    name: "spree_tax_rates_tax_category_id_fk"
  )
  ...
  add_foreign_key(
    ...
    "spree_variants",
    column: "variant_id",
    name: "subscription_line_items_variant_id_fk"
  )
  ...
  add_foreign_key(
    ...
    name: "subscriptions_bill_address_id_fk"
  )
  add_foreign_key(
    "subscriptions",
    "spree_addresses",
    column: "ship_address_id",
    name: "subscriptions_ship_address_id_fk"
  )
  add_foreign_key(
    "subscriptions",
    "spree_payment_methods",
    column: "payment_method_id",
    name: "subscriptions_payment_method_id_fk"
  )
  add_foreign_key(
    "subscriptions",
    "spree_shipping_methods",
    column: "shipping_method_id",
    name: "subscriptions_shipping_method_id_fk"
  )
