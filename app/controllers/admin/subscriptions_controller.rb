  ...
  class SubscriptionsController < Admin::ResourceController
    ...
    def load_shops
      @shops = Enterprise
        .managed_by(spree_current_user)
        .is_distributor
        .where(enable_subscriptions: true)
    end
    ...
    def managed_enterprise_id
      Enterprise.managed_by(spree_current_user).select("enterprises.id").find_by(id: params[:enterprise_id])
    end

    def subscription_params
      @subscription_params ||= PermittedAttributes::Subscription
        .new(params)
        .call
        .to_h
