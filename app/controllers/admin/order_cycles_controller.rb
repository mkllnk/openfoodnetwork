...
module Admin
  class OrderCyclesController < Admin::ResourceController
    class DateTimeChangeError < StandardError
    end
    ...
    def create
      @order_cycle_form = OrderCycles::FormService.new(
        @order_cycle,
        order_cycle_params,
        spree_current_user
      )
    ...
    def update
      ...
      render(
        json: {trigger_action: params[:trigger_action]},
        ...
        Subscription.where(schedule_id: schedule.id).find_each do |subscription|
          ...
          subscription.subscription_line_items.nil_price_estimate.each do |line_item|
            variant = OrderManagement::Subscriptions::VariantsList
              ...
              .find_by(id: line_item.variant_id)
    ...
    def clone
      ...
      @order_cycle.clone!
      redirect_to(
        main_app.admin_order_cycles_path,
    ...
    def require_coordinator
      @order_cycle.coordinator = permitted_coordinating_enterprises_for(@order_cycle).find_by(
        id: params[:coordinator_id]
      )
    ...
    def order_cycle_set
      @order_cycle_set ||= Sets::OrderCycleSet.new(
        @order_cycles,
        {
          **order_cycle_bulk_params,
          confirm_datetime_change: params[:confirm],
    ...
    def require_order_cycle_set_params
      ...
      render(
        json: {errors: t("admin.order_cycles.bulk_update.no_data")},
        status: :unprocessable_entity
      )
    end
    ...
    def order_cycle_params
      @order_cycle_params ||= PermittedAttributes::OrderCycle
        .new(params)
        .call
        .to_h
