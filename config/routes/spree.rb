...
Spree::Core::Engine.routes.draw do
  ...
  match(
    "/admin/orders/bulk_management" => "admin/orders#bulk_management",
    :as => "admin_bulk_order_management",
    :via => :get
  )
  match(
    "/admin/payment_methods/show_provider_preferences" => "admin/payment_methods#show_provider_preferences",
    :via => :get
  )
