...
RSpec.describe BackorderJob do
  ...
  describe ".check_stock" do
    ...
    it "places an order", vcr: true do
      ...
      variant.semantic_links << SemanticLink.new(
        semantic_id: "https://env-0105831.jcloud-ver-jpe.ik-server.com/api/dfc/Enterprises/test-hodmedod/SuppliedProducts/44519466238259"
      )
  ...
  describe ".best_offer" do
    it "finds a linked offer", vcr: true do
      ...
      offer = BackorderJob.best_offer(user, variant)

      expect(offer.semanticId).to eq "https://env-0105831.jcloud-ver-jpe.ik-server.com/api/dfc/Enterprises/test-hodmedod/SuppliedProducts/44519466238259/Offer"
    end
  end
end
