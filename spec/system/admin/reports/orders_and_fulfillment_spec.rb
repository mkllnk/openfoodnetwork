  ...
  describe "reports" do
    ...
    describe "Order Cycle Customer Totals" do
      ...
      context("with two orders on the same day at different times") do
        # 1500 hours in the past
        let(:completed_at1) { 1500.hours.ago }
        # 1700 hours in the past
        let(:completed_at2) { 1700.hours.ago }
        # 1600 hours in the past
        let(:datetime_start1) { 1600.hours.ago }
        # 1600 hours in the past
        let(:datetime_start2) { 1800.hours.ago }
        # 1400 hours in the past
        let(:datetime_end) { 1400.hours.ago }
        ...
        it "is precise to time of day, not just date" do
          ...
          # hides the summary rows
          find("#display_summary_row").set(false)
          run_report
          ...
          # displays the summary rows
          find("#display_summary_row").set(true)
          run_report
          # Then I should see the rows for the first order but not the second
        ...
        describe "Totals" do
          ...
          context("with the header row option not selected") do
            before do
              ...
              find("#display_header_row").set(false)
              run_report
            end
          ...
          context("with the header row option selected") do
            before do
              ...
              find("#display_header_row").set(true)
              run_report
            end
