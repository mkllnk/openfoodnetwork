...
RSpec.describe "Enterprise Summary Fee with Tax Report By Producer" do
  ...
  context("added tax") do
    ...
    describe "orders" do
      ...
      let(:summary_row1) {
        [
          # Ensure summary row follows the right supplier
          cost_of_produce1,
          # Fees and line items
          "TOTAL",
          # Tax excl: 15 + 100
          "115.0",
          # Tax     : (0.23 + 0.38) + (1.50 + 2.50)
          "4.61",
          # Tax incl: 100.00 + 15 + (0.23 + 0.38) + (1.50 + 2.50)
          "119.61"
        ].join(" ")
      }
