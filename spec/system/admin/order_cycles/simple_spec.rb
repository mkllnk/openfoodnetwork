...
"
  ...
  it "updating many order cycle opening/closing times at once" do
    ...
    expect(order_cycles.map(&:name)).to(
      eq(
        [
  ...
  context("as an enterprise user") do
    ...
    let!(:distributor_permitted_fee1) {
      create(
        :enterprise_fee,
        :per_item,
        enterprise: distributor_permitted,
      ...
      it "creating a new order cycle" do
        ...
        expect(page).to(
          have_select(
            ...
            options: [
              "",
              distributor_permitted_fee1.name,
              distributor_permitted_fee2.name,
              distributor_permitted_fee3.name,
              distributor_permitted_fee4.name
            ]
          )
        )
        ...
        expect(order_cycle.distributor_shipping_methods).to(
          match_array(
            order_cycle.attachable_distributor_shipping_methods
          )
        )
        expect(order_cycle.distributor_payment_methods).to(
          match_array(
    ...
    context("that is a manager of a participating producer") do
      ...
      it "editing an order cycle" do
        ...
        expect(page).to(
          have_checked_field(
            "order_cycle_outgoing_exchange_0_variants_#{v1.id}",
            disabled: false
          )
        )
        ...
        expect(page).to(
          have_checked_field(
            "order_cycle_outgoing_exchange_0_variants_#{v2.id}",
            disabled: true
          )
        )
    ...
    context("that is the manager of a participating hub") do
      ...
      it "editing an order cycle" do
        ...
        expect(page).to(
          have_checked_field(
            "order_cycle_incoming_exchange_0_variants_#{v1.id}",
            disabled: false
          )
        )
        ...
        expect(page).to(
          have_checked_field(
            "order_cycle_incoming_exchange_0_variants_#{v2.id}",
            disabled: true
          )
        )
  ...
  it(
    "modify the minute of a order cycle with the keyboard, " \
