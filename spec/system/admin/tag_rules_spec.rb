...
RSpec.describe "Tag Rules" do
  ...
  context("updating", feature: :inventory) do
    ...
    it "saves changes to rules of each type" do
      ...
      expect(page).to(
        have_selector(
          "#customer-tag-rule .header",
          text: "For customers tagged:",
          count: 4
        )
      )
      expect(page).to(
        have_selector(
          "#customer-tag-rule .header .tags-input .tag-list .tag-item",
          text: "member",
          count: 1
        )
      )
      ...
      within("#customer-tag-rule #tr_1001") do
        ...
        expect(page).to(
          have_select(
            "enterprise_tag_rules_attributes_1001_preferred_matched_" \
              "variants_visibility",
            selected: "VISIBLE"
          )
        )
      ...
      within("#customer-tag-rule #tr_2001") do
        ...
        expect(page).to(
          have_select(
            "enterprise_tag_rules_attributes_2001_preferred_matched_" \
              "payment_methods_visibility",
      ...
      within("#customer-tag-rule #tr_3001") do
        ...
        expect(page).to(
          have_select(
            "enterprise_tag_rules_attributes_3001_preferred_matched_" \
              "order_cycles_visibility",
            selected: "VISIBLE"
          )
        )
      ...
      within("#customer-tag-rule #tr_4001") do
        ...
        expect(page).to(
          have_select(
            "enterprise_tag_rules_attributes_4001_preferred_matched_" \
              "shipping_methods_visibility",
            selected: "NOT VISIBLE"
          )
        )
