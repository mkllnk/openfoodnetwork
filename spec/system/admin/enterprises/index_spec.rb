...
RSpec.describe "Enterprises Index" do
  ...
  describe "as the manager of an enterprise" do
    ...
    context("listing enterprises") do
      ...
      it(
        "does not give me an option to change or update the package and " \
          "producer properties of enterprises I manage"
      ) do
        visit(admin_enterprises_path)
  ...
  describe "as the owner of an enterprise" do
    ...
    context("listing enterprises") do
      it(
        "allows me to change or update the package and " \
          "producer properties of enterprises I manage"
      ) do
        visit(admin_enterprises_path)
