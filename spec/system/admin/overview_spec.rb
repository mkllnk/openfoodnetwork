...
"
  ...
  context("as an enterprise user") do
    before do
      ...
      allow_any_instance_of(Spree::Admin::OverviewController).to(
    ...
    context("with multiple enterprises") do
      ...
      before do
        ...
        @enterprise_user
          .enterprise_roles
          .build(enterprise: non_distributor_enterprise)
          .save
      end
      ...
      it "displays information about the enterprise" do
        ...
        expect(page).to(
          have_selector(
            ".dashboard_item#enterprises .list-item",
            text: non_distributor_enterprise.name
          )
        )
        expect(page).to(
          have_selector(
            ".dashboard_item#enterprises .button.bottom",
      ...
      context("but no products or order cycles") do
        it "prompts the user to create a new product and to manage order cycles" do
          ...
          expect(page).to(
            have_selector(
              ".dashboard_item#products .list-item",
              text: "You don't have any active products."
            )
          )
          expect(page).to(
            have_selector(
              ".dashboard_item#products .button.bottom",
          ...
          expect(page).to(
            have_selector(
              ".dashboard_item#order_cycles .list-item",
              text: "You don't have any active order cycles."
            )
          )
          expect(page).to(
            have_selector(
              ".dashboard_item#order_cycles .button.bottom",
