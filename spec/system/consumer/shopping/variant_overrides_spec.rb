...
RSpec.describe "shopping with variant overrides defined", feature: :inventory do
  ...
  describe "viewing products" do
    ...
    it "shows the overridden price with fees in the quick cart" do
      ...
      expect(page).to(
        have_selector(
          "#cart-variant-#{product1_variant1.id} .total-price",
    ...
    it "shows the correct prices in the shopping cart" do
      ...
      expect(page).to(
        have_selector(
          "tr.line-item.variant-#{product1_variant1.id} .cart-item-price",
      ...
      expect(page).to(
        have_selector(
          "tr.line-item.variant-#{product1_variant1.id} .cart-item-total",
          text: with_currency(122.22)
        )
      )
  ...
  describe "creating orders" do
    ...
    it "subtracts stock from the override" do
      ...
      expect do
        expect do
          ...
          .to(change { product1_variant3.reload.on_hand }.by(0))
      end
        .to(change { product1_variant3_override.reload.count_on_hand }.by(-2))
    end
    ...
    it "subtracts stock from stock-overridden on_demand variants" do
      ...
      expect do
        expect do
          ...
          .to(change { product3_variant2.reload.on_hand }.by(0))
      end
        .to(change { product3_variant2_override.reload.count_on_hand }.by(-2))
    end
    ...
    it "does not subtract stock from overrides that do not override count_on_hand" do
      ...
      expect do
        ...
        .to(change { product1_variant1.reload.on_hand }.by(-2))
    ...
    it "subtracts stock from override but not variants where the override has on_demand: true" do
      ...
      expect do
        ...
        .to(change { product4_variant1.reload.on_hand }.by(0))
