    ...
    context("when the order is linked to a customer") do
      it "removes the customer" do
        ...
        expect do
          ...
          .to(change { controller.current_order.customer }.to(nil))
      end
    end
      ...
      context("when customer doesn't belong to the order's distributor") do
        it "sets the order's customer to distributor's customer" do
          ...
          expect do
            ...
            .to(change { controller.current_order.customer }.to(expected_customer))
        end
      end
    end
  ...
  context("checking access on nonexistent enterprise") do
    ...
    it "shows a flash message with the error" do
      expect(request.flash[:error]).to(
        eq(
          "The shop you are looking for doesn't exist or " \
