  ...
  describe "updating an enterprise" do
    ...
    context("as manager") do
      ...
      it "updates the contact for notifications" do
        ...
        expect { spree_post(:update, params) }.to(change { distributor.contact }.to(distributor_manager))
      end
      ...
      it "doesn't update the contact for notifications if the :contact_id parameter is invalid" do
        ...
        expect { spree_post(:update, params) }.not_to(change { distributor.contact })
      end
    ...
    context("as super admin") do
      ...
      it "allows 'external_billing_id' to be changed" do
        allow(controller).to(receive_messages(spree_current_user: admin_user))
        enterprise_params = {id: profile_enterprise, enterprise: {external_billing_id: "INV123456"}}
  ...
  describe "for_order_cycle" do
    ...
    context("when an order_cycle_id is provided in params") do
      ...
      it "initializes permissions with the existing OrderCycle" do
        expect(OpenFoodNetwork::OrderCyclePermissions).to(
          have_received(:new)
  ...
  describe "visible" do
    ...
    it "uses permissions to determine which enterprises are visible and should be rendered" do
      expect(controller).to(
        receive(:render_as_json)
          .with([visible_enterprise], ams_prefix: "basic", spree_current_user: user)
          .and_call_original
      )
