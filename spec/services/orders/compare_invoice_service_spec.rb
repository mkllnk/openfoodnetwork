...
RSpec.shared_examples("associated attribute changes - adjustments (create/delete)") do |boolean, type|
  ...
  describe "#can_generate_new_invoice?" do
    ...
    context("changes on the order object") do
      describe "detecting relevant" do
        ...
        it_behaves_like(
          "associated attribute changes - adjustments (create/delete)",
          true,
          "relevant"
        )
        it_behaves_like(
          "associated attribute changes - adjustments (edit amount)",
          true,
          "relevant"
        )
      ...
      describe "detecting non-relevant" do
        ...
        it_behaves_like(
          "associated attribute changes - adjustments (edit label)",
          false,
          "non-relevant"
        )
  ...
  describe "#can_update_latest_invoice?" do
    ...
    context("changes on the order object") do
      ...
      describe "detecting non-relevant" do
        ...
        it_behaves_like(
          "associated attribute changes - payments",
          false,
          "non-relevant"
        ) do
