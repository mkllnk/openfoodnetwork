    ...
    describe "making labels" do
      ...
      describe "#line_item_adjustment_label" do
        it "makes an adjustment label for a line item" do
          expect(applicator.__send__(:line_item_adjustment_label)).to(
            eq("Bananas - packing name fee by distributor Ballantyne")
          )
        end
      end
      ...
      describe "#order_adjustment_label" do
        ...
        it "makes an adjustment label for an order" do
          expect(applicator.__send__(:order_adjustment_label)).to(
            eq("Whole order - packing name fee by distributor Ballantyne")
          )
        end
      end
    end
