...
RSpec.describe Spree::Product do
    ...
    context("when the product has variants") do
      ...
      context("saving a new product") do
        ...
        context("with variant attributes") do
          it {
            is_expected.to(
              validate_presence_of(:variant_unit)
                .on(:create_and_create_standard_variant)
            )
          }
          it {
            is_expected.to(
              validate_presence_of(:supplier_id)
                .on(:create_and_create_standard_variant)
            )
          }
          it {
            is_expected.to(
              validate_presence_of(:primary_taxon_id)
                .on(:create_and_create_standard_variant)
            )
          }
          ...
          describe "unit_value" do
            ...
            it {
              is_expected.to(
                validate_numericality_of(:unit_value)
                  .is_greater_than(0)
                  .on(:create_and_create_standard_variant)
              )
            }
            it {
              is_expected.not_to(
                validate_presence_of(:unit_value)
                  .on(:create_and_create_standard_variant)
              )
            }
            ...
            describe "unit_description" do
              it {
                is_expected.not_to(
                  validate_presence_of(:unit_description)
                    .on(:create_and_create_standard_variant)
                )
              }
            ...
            describe "variant_unit_scale" do
              it {
                is_expected.not_to(
                  validate_presence_of(:variant_unit_scale)
                    .on(:create_and_create_standard_variant)
                )
              }
            ...
            describe "variant_unit_name" do
              ...
              it {
                is_expected.not_to(
                  validate_presence_of(:variant_unit_name)
                    .on(:create_and_create_standard_variant)
                )
              }
  ...
  describe "scopes" do
    ...
    describe "in_distributors" do
      ...
      it "returns distributed products for a given Enterprise AR relation" do
        ...
        expect(described_class.in_distributors(distributors)).to(include(product1, product2, product3))
      ...
      it "returns distributed products for a given array of enterprise ids" do
        ...
        expect(described_class.in_distributors(distributors_ids)).to(include(product1, product2, product3))
  ...
  describe "#properties_including_inherited" do
    ...
    it "sorts by position" do
      ...
      expect(product.properties_including_inherited).to(
        eq(
          [
