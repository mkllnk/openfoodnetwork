    ...
    describe ".adjust" do
      ...
      context("taxable line item") do
        ...
        context("when price includes tax") do
          ...
          context(
            "when order's zone is neither the default zone, or included " \
              "in the default zone, but matches the rate's zone"
          ) do
            before do
          ...
          context(
            "when order's zone does not match default zone, is not included in the " \
              "default zone, AND does not match the rate's zone"
          ) do
